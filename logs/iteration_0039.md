# Hadamard Max-Det Research — Iteration 0039

**Timestamp:** 2026-04-28 12:10:03
...
1. `legendre_sym_v0` (strategy_hermod_legendre_symmetric)
2. `legendre_sym_v1` (strategy_hermod_legendre_symmetric)
3. `legendre_sym_v2` (strategy_hermod_legendre_symmetric)
4. `legendre_sym_v3` (strategy_hermod_legendre_symmetric)
5. `legendre_sym_v4` (strategy_hermod_legendre_symmetric)
...
|---|------|--------|---------|--------|
| 1 | `legendre_sym_v0` | 1,521,681,143,169,024 | 38.8211% | strategy_hermod_legendre_symmetric |
| 2 | `legendre_sym_v2` | 847,516,501,278,725 | 21.6218% | strategy_hermod_legendre_symmetric |
| 3 | `legendre_sym_v3` | 25,165,824 | 0.0000% | strategy_hermod_legendre_symmetric |
| 4 | `legendre_sym_v1` | 0 | 0.0000% | strategy_hermod_legendre_symmetric |
| 5 | `legendre_sym_v4` | 0 | 0.0000% | strategy_hermod_legendre_symmetric |
...
**Top determinant:** 1,521,681,143,169,024 (38.8211% of Barba)
  Construction: strategy_hermod_legendre_symmetric
  Improves record? No

**Method performance this iteration:**
  strategy_hermod_legendre_symmetric: best=1,521,681,143,169,024 = (was 1,521,681,143,169,024)
